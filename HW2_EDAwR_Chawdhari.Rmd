...
```{r}
ggplot(data=county_df, aes(county_df$Income)) + geom_histogram()

ggplot(data = county_df) + geom_histogram(mapping = aes(x = county_df$Income) ,binwidth = 1000)
ggplot(data = county_df) + geom_boxplot(mapping = aes(x = "Mean Income", y = county_df$Income ))


ggplot(data = county_df) +   geom_density(mapping = aes(x = county_df$Income))

ggplot(data=county_df, aes(y = county_df$Income,x = "count")) + geom_violin()
...
ggplot(county_df,aes(x = county_df$Region)) + geom_bar() + labs(title = "Number of Counties By Region", x="Region" , y="Count")
```
